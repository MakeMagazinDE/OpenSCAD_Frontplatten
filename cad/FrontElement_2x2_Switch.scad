...
thick=2.5,      //verbleibende Dicke des Frontplattensegments
...
FSdst=10.6,     //Abstand Frontschrauben
...
//Bohrungen für Drehschalter mit Pin, Knopf 20mm (Mindestgröße 2x2)
...
translate([xwert*segment/2,ywert*segment/2,thick-0.2])  cylinder(d=19, h=10, $fn=32);
translate([xwert*segment/2-FSdst/2,ywert*segment/2-FSdst/2,-0.1])  cylinder(d=2.2, h=10, $fn=32);
translate([xwert*segment/2-FSdst/2,ywert*segment/2+FSdst/2,-0.1])  cylinder(d=2.2, h=10, $fn=32);
translate([xwert*segment/2+FSdst/2,ywert*segment/2-FSdst/2,-0.1])  cylinder(d=2.2, h=10, $fn=32);
translate([xwert*segment/2+FSdst/2,ywert*segment/2+FSdst/2,-0.1])  cylinder(d=2.2, h=10, $fn=32);
translate([xwert*segment/2-FSdst/2,ywert*segment/2-FSdst/2,thick-1.1])  cylinder(d=4, h=10, $fn=32);
translate([xwert*segment/2-FSdst/2,ywert*segment/2+FSdst/2,thick-1.1])  cylinder(d=4, h=10, $fn=32);
translate([xwert*segment/2+FSdst/2,ywert*segment/2-FSdst/2,thick-1.1])  cylinder(d=4, h=10, $fn=32);
translate([xwert*segment/2+FSdst/2,ywert*segment/2+FSdst/2,thick-1.1])  cylinder(d=4, h=10, $fn=32);
